...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "dev-not-for-production")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.library.context_processors.immich",
            ],
        },
    }
]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "nakavid"),
        "USER": os.getenv("POSTGRES_USER", "nakavid"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "nakavid"),
